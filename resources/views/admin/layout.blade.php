        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <li class="menu-item">
                        <a href="/admin/interface" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Giao diện</div>
                        </a>
                  ...
                  <li class="menu-item">
                      ...
                      <ul class="menu-sub">
                          <li class="menu-item">
                              <a href="/admin/create-catalogue" class="menu-link">
                                  <div data-i18n="Account">Tạo catalogue</div>
                              </a>
                          </li>
                          <li class="menu-item">
